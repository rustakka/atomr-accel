...
impl From<driver_sys::CUgraphExecUpdateResult> for GraphExecUpdateOutcome {
    fn from(r: driver_sys::CUgraphExecUpdateResult) -> Self {
        // CUDA_GRAPH_EXEC_UPDATE_SUCCESS = 0
        match r as u32 {
...
pub fn exec_update(
    ...
    let probe = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let mut info = driver_sys::CUgraphExecUpdateResultInfo_st {
            result: driver_sys::CUgraphExecUpdateResult_enum::CUDA_GRAPH_EXEC_UPDATE_SUCCESS,
...
mod tests {
    ...
    fn outcome_classification_round_trip() {
        ...
        assert_eq!(
            GraphExecUpdateOutcome::from(CUDA_GRAPH_EXEC_UPDATE_SUCCESS),
