//! Demonstrates the rakka-cuda pipeline pattern surface without a
...
//!
//! Run with: `cargo run -p rakka-cuda --example pipeline_no_gpu`

use rakka_cuda::error::GpuError;
use rakka_cuda::pipeline::PipelineStage;
...
async fn main() {
    ...
    println!("rakka-cuda pipeline-no-gpu demo");
