//! Observability glue: install [`rakka_telemetry::TelemetryExtension`]
...
//!
//! The dashboard at `rakka-dashboard/` (in the rakka workspace)
//! consumes the resulting [`rakka_telemetry::dto::NodeSnapshot`] over
//! WebSocket — point it at any rakka-accel-cuda host and the GPU probes
...
/// let _telemetry = rakka_accel_cuda::observability::install(&sys, "gpu-host-1");
/// ```
