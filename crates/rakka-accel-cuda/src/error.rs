...
use rakka_core::supervision::{Directive, OneForOneStrategy, SupervisorOf, SupervisorStrategy};
...
///
/// rakka 0.2.0 added the [`SupervisorOf`] trait so a parent can decide
...
/// Blanket `SupervisorOf<C>` impl: any rakka actor `C` whose failures
