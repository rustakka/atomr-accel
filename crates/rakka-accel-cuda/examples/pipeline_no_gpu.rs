//! Demonstrates the rakka-accel-cuda pipeline pattern surface without a
...
//!
//! Run with: `cargo run -p rakka-accel-cuda --example pipeline_no_gpu`

use rakka_accel_cuda::error::GpuError;
use rakka_accel_cuda::pipeline::PipelineStage;
