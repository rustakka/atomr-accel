"""rakka-accel — actor-shaped face for NVIDIA CUDA, exposed to Python.

The native extension lives in ``rakka_accel._native``; everything you
typically need is re-exported here. Downstream libraries should import
from ``rakka_accel`` (this module) and treat ``_native`` as private.
...
...     except rakka_accel.Unrecoverable as e:
