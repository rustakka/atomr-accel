//! `System` — wraps a `atomr_core::actor::ActorSystem` for Python
...
use atomr_core::actor::ActorSystem as RustSystem;

use crate::device::PyDevice;
use crate::errors;
use crate::runtime::runtime;

#[pyclass(name = "System", module = "atomr_accel._native")]
pub struct PySystem {
...
impl PySystem {
    ...
    #[staticmethod]
    #[pyo3(signature = (name="atomr-accel".to_string()))]
    ...
    pub fn spawn_device(
        ...
        use atomr_accel_cuda::device::{DeviceActor, DeviceConfig};
        let cfg = if mock {
